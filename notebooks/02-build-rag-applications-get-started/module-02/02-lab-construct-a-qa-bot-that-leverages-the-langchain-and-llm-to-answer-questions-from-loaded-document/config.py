...
LLM_TEMPERATURE = 0.2   # low enough for factual answers; non-zero avoids degenerate repetition
...
CHUNK_OVERLAP = 200  # 20% of CHUNK_SIZE — ensures a sentence at a boundary appears in both adjacent chunks
...
# Instructs the LLM to stay grounded in the retrieved context — prevents the model
# from drawing on its training data to fill gaps the document doesn't cover.
